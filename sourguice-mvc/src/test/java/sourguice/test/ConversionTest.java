...
public class ConversionTest extends TestBase {
	...
	public void getPrimReqArray() throws Exception {
        ...
        request.addHeader("x-sj-exc", "com.github.sourguice.throwable.converter.CannotConvertToPrimitiveException");
	...
	public void getNoConverter() throws Exception {
        ...
        request.addHeader("x-sj-exc", "com.github.sourguice.throwable.converter.NoConverterException");

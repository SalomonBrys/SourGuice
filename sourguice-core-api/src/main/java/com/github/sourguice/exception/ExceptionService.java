...
public interface ExceptionService {
	 ...
	 */
	public abstract <T extends Exception>void registerHandler(Class<? extends T> clazz, ExceptionHandler<? super T> handler) throws UnreachableExceptionHandlerException;
